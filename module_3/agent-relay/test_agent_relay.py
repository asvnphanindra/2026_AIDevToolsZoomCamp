...
# Use the OS temp dir so this works on Windows as well as Unix.
_default_test_db = Path(tempfile.gettempdir()) / "agent-relay-test.db"
os.environ.setdefault("RELAY_DATABASE_URL", f"sqlite:///{_default_test_db.as_posix()}")
