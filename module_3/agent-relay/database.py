...
def immediate_transaction() -> Generator[Session, None, None]:
    ...
    On SQLite, ``BEGIN IMMEDIATE`` serializes claims because SQLite has no
    ``FOR UPDATE SKIP LOCKED``. On PostgreSQL, a normal transaction is used and
    claim queries take row locks via ``FOR UPDATE SKIP LOCKED``.
    """
